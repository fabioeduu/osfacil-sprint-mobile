...
type EditarClienteScreenRouteProp = RouteProp<RootStackParamList, 'EditarCliente'>;

export default function EditarClienteScreen() {
  const route = useRoute<EditarClienteScreenRouteProp>();
    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        <View style={styles.iconContainer}>
          <Ionicons name="person" size={64} color="#3498db" />
        </View>
        <Text style={styles.title}>Editar Cliente</Text>
        <Text style={styles.subtitle}>Cliente ID: {clienteId}</Text>
