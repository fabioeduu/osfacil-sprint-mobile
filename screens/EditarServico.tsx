...
type EditarServicoScreenRouteProp = RouteProp<RootStackParamList, 'EditarServico'>;

export default function EditarServicoScreen() {
  const route = useRoute<EditarServicoScreenRouteProp>();
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>Serviço ID: {servicoId}</Text>
