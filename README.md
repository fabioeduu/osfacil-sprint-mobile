...
### Features
- ✅ **Notificações Locais**: Alertas em tempo real para criação/atualização de ordens
- ✅ **Tela "Sobre o App"**: Exibe versão, commit hash e features
- ✅ **Grid Layouts**: Visualização 2-colunas para clientes e veículos
- ✅ **Integração APEX Completa**: Todas as operações processadas no backend
- ✅ **Architecture Review**: Separação de responsabilidades, hooks, services
